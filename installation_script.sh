...
devopsfetch --time 2024-07-18 2024-07-22 -> should show all activities from 18th till today.
./devopsfetch --time 2024-07-21 -> should show all activities that happened on the server yesterdaydisplay_nginx() {
    if [ -z "$1" ]; then
...
echo "Installation complete. The devopsfetch service is now running and logging."
